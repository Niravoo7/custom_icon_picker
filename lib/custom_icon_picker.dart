...
library custom_icon_picker;

export 'Models/IconPack.dart';
export 'Models/IconModel.dart';
export 'Serialization/iconDataSerialization.dart';

import 'package:custom_icon_picker/Models/IconModel.dart';
...
class FlutterIconPicker {
  static Future<IconModel> showIconPicker(
    ...
    if (iconPicked != null) {
      //return IconModel(iconPicked,"test");
      return iconPicked;
    }
    return null;
  }
